...
public class App {
    public static void main(String[] args) throws IOException, ClassNotFoundException{
        ...
        File[] files = directory.listFiles();
            ...
            int avgCompressTime = 0;
            int avgDifferenceSize = 0;
            double avgRatio = 0;
            int avgDecompressTime = 0;
            double avgMAE = 0;
            double avgMSE = 0;
            double avgPSNR = 0;
            int counter = 0;
        ...
        if (files != null) {
            ...
            for (File file : files) {
                ...
                avgCompressTime += compressExecutionTime;
                avgDecompressTime += decompressExecutionTime;
                avgDifferenceSize += differenceInFileSize;
                avgRatio = avgRatio + ( (double) originalFileSize/compressedFileSize);
                avgMAE += MAE;
                avgMSE += MSE;
                avgPSNR += PSNR;
                counter++;
        ...
        System.out.println("avgCompressTime = " + avgCompressTime/counter + " ms");
        System.out.println("avgDecompressTime = " + avgDecompressTime/counter + " ms");
        System.out.println("avgDifferenceSize = " + avgDifferenceSize/counter + " bytes");
        System.out.println("avgRatio = " + avgRatio/counter + " ori:compressed");
        System.out.println("avgMAE = " + avgMAE/counter);
        System.out.println("avgMSE = " + avgMSE/counter);
        System.out.println("avgPSNR = " + avgPSNR/counter);
